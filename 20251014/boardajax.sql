...
CREATE TABLE ACCOUNT_TB (
  ACCOUNT_SEQ INT PRIMARY KEY AUTO_INCREMENT,
  PROFIT_COST VARCHAR(11) DEFAULT NULL,
  BIG_GROUP VARCHAR(11) DEFAULT NULL,
  MIDDLE_GROUP VARCHAR(11) DEFAULT NULL,
  SMALL_GROUP VARCHAR(11) DEFAULT NULL,
  DETAIL_GROUP VARCHAR(11) DEFAULT NULL,
  COMMENTS VARCHAR(200) DEFAULT NULL,
  TRANSACTION_MONEY DECIMAL(15,0) DEFAULT NULL,
